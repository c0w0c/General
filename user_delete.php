...
if (isset($_POST["del"])) {  // 是否是表單送回
   $sql = "DELETE FROM emp WHERE work_id='" . $id . "'";
   if (!mysql_query($sql)) // 執行SQL指令
        $er = "刪除記錄失敗...<br/>" . mysql_error();
   else header("Location: user_ad.php"); // 轉址
}
...
<div data-role="content" style="width: 75%;margin: 0px auto;" >
    ...
    <form action="" method="post" data-ajax="false">
        <ul data-role="listview" data-inset="true">
            <li data-role="list-divider" style="text-align: center;font-size:large;">刪除工號 <strong style="color: red;"><?php echo $id ?></strong> 的帳號</li>
