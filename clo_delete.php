...
if (isset($_POST["del"])) {  // 是否是表單送回
   $sql = "DELETE FROM clo_app WHERE id='" . $id . "'";
   if (!mysql_query($sql)) // 執行SQL指令
        $er = "刪除記錄失敗...<br/>" . mysql_error();
   else header("Location: clo_ad.php"); // 轉址
}
...
<body>
<div data-role="page" data-title="刪除衣物紀錄">
    ...
    <form action="" method="post" data-ajax="false">
        <ul data-role="listview" data-inset="true">
            ...
            <li class="ui-field-contain">
                <p style="text-align: center;font-size: large;">您確定要刪除資料!?</p>
                <p style="text-align: center;font-size: medium;">資料刪除後將不能復原!!</p>
            </li>
            <li class="ui-field-contain">
            <div class="ui-grid-a">
