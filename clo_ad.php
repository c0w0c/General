...
switch($user_pur){
  case'1':
    ...
    break;
  case'2':
    $sql = "SELECT * FROM clo_app WHERE app_name LIKE '%".$user_name."%' ORDER BY id DESC";
    $titeltext = '衣物申請紀錄';
    break;
}
...
<div data-role="navbar">
	<ul>
	<li><a href="clo_ad_key_search.php?key=%E5%B0%9A%E6%9C%AA%E8%AE%80%E5%8F%96" target="_self">尚未讀取</a></li>
	<li><a href="clo_ad_key_search.php?key=%E6%BA%96%E5%82%99%E4%B8%AD" target="_self">準備中</a></li>
  <li><a href="clo_ad_key_search.php?key=%E5%B7%B2%E7%99%BC%E9%80%81" target="_self">已發送</a></li>
  <?php //管理者專用
    if ( $user_pur == '1') {
      echo "<li><a href='clo_ad_key_search.php?key=list' target='_self'>清單</a></li>";
    }
  ?>
	</ul>
</div><!-- /navbar -->
    <?php
            ...
            if ( $pages > 1 )  // 顯示上一頁
            echo "<a href='clo_ad.php?Pages=".($pages-1).
            ...
            if ($i != $pages) // 顯示頁碼
            echo "<option value='clo_ad.php?Pages=".$i."'>".$i."</option>";
            echo "</form></select>";
...
<div data-role="content" >
      <?php //管理者專用
        if ( $user_pur == '1') {
          echo"<div class='titel'><span class='titeltext'>衣物數量管理</span></Div><div class='ui-grid-a'><div class='ui-block-a'><a class='ui-btn ui-corner-all ui-icon-edit ui-btn-icon-right ui-mini' target='_self' href='clo_inv_rec.php'><h3>扣補帳系統</h3></a></div><div class='ui-block-b'><a class='ui-btn ui-corner-all ui-icon-grid ui-btn-icon-right ui-mini' target='_self' href='clo_inv_rec_log.php'><h3>扣補帳紀錄</h3></a></div></div>";
        }
      ?>
...
<form action="clo_ad_key_search.php" method="GET" data-ajax="false">
<table>
  <tr>
